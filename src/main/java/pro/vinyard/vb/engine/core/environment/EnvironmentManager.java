...
public class EnvironmentManager {
    ...
    private void appendCategory(StringBuilder stringBuilder, String category) {
        ...
        stringBuilder.append(this.getLineSeparator());
    }
    ...
    public String displayEnvironmnent() {
        ...
        appendLine.accept("Home directory", this.getHomeDirectoryPath());
        appendLine.accept("Working directory", this.getWorkingDirectory());
        appendCategory.accept("Java environnement");
        appendLine.accept("Java version", this.getJavaVersion());
        appendLine.accept("Jar File", this.getJarFileLocation());
        appendLine.accept("Jar directory", this.getJarDirectoryLocation());
        appendCategory.accept("System environnement");
        appendLine.accept("Operating system", this.getOperatingSystem());
